...
class DocDetailState extends State<DocDetail> {
  ...
  void _submitForm() {
    ...
    if (!form.validate()) {
      showMessage('Alguns campos estão incorretos..');
    } else {
      _saveDoc();
    }
  }
  ...
  Widget build(BuildContext context) {
    const String cStrDays = "Digite o número de dias";
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            title: Text(ttl != "" ? widget.doc.title : "Novo documento"),
            ...
            child: SafeArea(
              ...
              child: ListView(
                ...
                children: <Widget>[
                    ...
                    Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintText: 'Data Expiração (i.e. ' + DateUtils.daysAheadAsStr(daysAhead) + ')',
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('a: Alerta de 1.5 & 1 ano')),
                    Switch(
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('b: Alerta  de 6 meses')),
                    Switch(
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('c: Alerta de 3 meses')),
                    Switch(
                  ...
                  Row(children: <Widget>[
                    Expanded(child: Text('d: Alerta de 1 mês')),
                    Switch(
